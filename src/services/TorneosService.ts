...
//       Descripción_Torneo:
//         "¡El torneo más grande del año! Ven y demuestra tus habilidades en este evento épico.",
...
//       Descripción_Torneo:
//         "¡Un torneo rápido y emocionante para aquellos que buscan acción inmediata!",
...
//   const torneo = (await listaTorneos).find((x) => x.idTorneo === id);
//   return torneo;
// };

// export const getTorneoMock = async (id: number) => {
//   const listaTorneos = getTorneosMock();
//   const torneo = (await listaTorneos).find((x) => x.idTorneo === id);
//   return torneo;
// };
