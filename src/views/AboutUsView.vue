  ...
  <v-container>
    ...
    <v-row justify="center">
      <v-col cols="12" md="8" class="text-center">
        <h1 class="text-h4 font-weight-bold">Sobre nosotros</h1>
        <p class="text-subtitle-1">
          Descubre las características de nuestra app y lo que viene en un
    ...
    <v-row>
      <v-col cols="12">
        <h2 class="text-h5 font-weight-bold mb-4">Características</h2>
      </v-col>
    ...
    <v-row>
      <v-col cols="12">
        <h2 class="text-h5 font-weight-bold mt-8 mb-4">Nuestra hoja de ruta</h2>
      </v-col>
      <v-col cols="12">
    ...
    <v-row justify="center" class="mt-8">
      <v-col cols="12" md="6" class="text-center">
        ...
        <p class="text-body-2">
          Si te gusta nuestra aplicación y quieres apoyarnos, puedes hacer una
          donación a través de PayPal. ¡Gracias por tu ayuda!
        </p>
        <v-btn
          color="primary"
          variant="tonal"
      ...
      features: [
        {
          ...
          description: "Crea y gestiona torneos fácilmente.",
        },
        {
          icon: ELO,
          title: "Sistema de ELO",
          description: "Ranking competitivo actualizado en tiempo real.",
        },
        {
          icon: clasificacion,
          title: "Ranking",
          description: "Clasificación de jugadores individual y por equipos.",
        },
      ],
      roadmap: [
        {
